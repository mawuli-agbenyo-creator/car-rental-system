...
//         newRideItem.textContent = `${rideName} - ${ridePrize} - ${rideDesc}`;
...
//         saveRideToLocalStorage(rideName, { car_name: rideName, prize: ridePrize, desc: rideDesc, img:rideImageUrl });
...
//             const newRideItem = document.createElement('li');
//             newRideItem.className = 'list-group-item';
//             newRideItem.textContent = `${rideDetails.car_name} - ${rideDetails.prize} - ${rideDetails.desc}`;
