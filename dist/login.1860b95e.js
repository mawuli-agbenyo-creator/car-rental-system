...
var buttonLogin = document.querySelector(".btn-block");
function loginUser() {
  ...
  try {
    var storedAdminData = localStorage.getItem("admin");
    if (storedAdminData) {
      var storedAdmin = JSON.parse(storedAdminData);
      if (emailInput === storedAdmin.email.toLowerCase() && passwordInput === storedAdmin.password) {
